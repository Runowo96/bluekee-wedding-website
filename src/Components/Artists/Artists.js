    ...
    <div className="artists">
      ...
      <div className="artists__cont">
        ...
        <div className="artists__info-cont">
          ...
          <p className="artists__bio">
            Blue combines years of expertise in the wedding and events industry
            with his technical skills as a software engineer and a deep passion
            for crafting with 3D printers, CNC machines, and laser cutters. His
            work blends creativity with precision, delivering custom,
            high-quality pieces for clients who value artistry and innovation.
          </p>
        </div>
      </div>
      ...
      <div className="artists__info-cont">
        ...
        <p className="artists__bio">
          ...
          with his technical skills as a software engineer and a deep passion
          for crafting with 3D printers, CNC machines, and laser cutters. His
          work blends creativity with precision, delivering custom, high-quality
          pieces for clients who value artistry and innovation.
        </p>
      </div>
